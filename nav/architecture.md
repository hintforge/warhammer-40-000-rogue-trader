...
| z-aviorus -- Sealed door (Compressor Hall) | No power; main door | Backup-generator puzzle (5 stabilisers, target pressure 10; subsets 1+2+5 or 2+3+4) | puzzle / ability | in-zone | yes | Gates Forgefiend boss; solution in `puzzles/aviorus_cathedral.md`. Activating the generator permanently +5 Veil Degradation for the level |
